...
fn main() {
    ...
    // Fix rms_norm_f16w calls - handle both 5-arg and already-6-arg cases
    ...
    // Fix matmul_row_major_f32 garbage calls (looking for the 8-line pattern)
    // Actually I will just replace the whole matmul blocks that are broken
    let broken_mm = ".matmul_row_major_f32(\n                                x,\n                                &weight_t_chunk[..in_dim * cols_n],\n                                1,\n                                cols_n,\n                                in_dim,\n                                cols_n,\n                                out_slice,\n                            )";
    let fixed_mm = ".matmul_row_major_f32(\n                                x,\n                                1,\n                                in_dim,\n                                &weight_t_chunk[..in_dim * cols_n],\n                                cols_n,\n                                out_slice,\n                            )";
    content = content.replace(broken_mm, fixed_mm);
